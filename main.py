    ...
    def __init__(self, master):
        ...
        try:
            ...
            while True:
                ...
                self.PirValue = Label(frame, text=(''), borderwidth=1).grid(row=3, column=2, padx=10, pady=10)
                self.PirValue = Label(frame, text=(pir), borderwidth=1).grid(row=3, column=2, padx=10, pady=10)
                temp, far = M.getTemp()
                self.TempValue = Label(frame, text=(''), borderwidth=1).grid(row=4, column=2, padx=10, pady=10)
                ...
                self.LightValue = Label(frame, text=(''), borderwidth=1).grid(row=5, column=2, padx=10, pady=10)
                ...
                self.DistValue = Label(frame, text=(''), borderwidth=1).grid(row=6, column=2, padx=10, pady=10)
